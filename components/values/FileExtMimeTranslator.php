<?php
/**
 * File Extension-Mime Translator
 *
...
class FileExtMimeTranslator
{
    ...
    public static function getExtMimes()
    {
        return
            [
    ...
    {
        $extMimes = self::getExtMimes();

        return array_keys($extMimes, $mime);
    }
    ...
    public static function getMimeByExtension($ext)
    {
        ...
        if (array_key_exists($ext, $extMimes)) {
            return $extMimes[$ext];
        }
